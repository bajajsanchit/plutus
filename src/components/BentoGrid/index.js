			...
			<div className={`${styles.grid}`}>
				<div className={`${styles.grid_item}`}>
					<div>
						...
						<p className={styles.description}>
							Attract unbeatable deals with our savvy savings strategies and
							exclusive offers.
						</p>
					</div>
				...
				<div className={`${styles.grid_item}`}>
					<div>
						...
						<p className={styles.description}>
							Unlock unparalleled rewards with strategies and our comprehensive
							calculator.
						</p>
					</div>
				...
				<div className={`${styles.grid_item}`}>
					<div>
						...
						<p className={styles.description}>
							Elevate your shopping savvy with our expert tools and insider
							tips.
						</p>
					</div>
					<video
						...
						playsInline
					>
						<source src="/video/plutus-test-vid-0.webm" type="video/webm" />
					</video>
				</div>

				<div className={`${styles.grid_item} ${styles.grid_logo}`}>
					<svg
						width="70%"
						viewBox="0 0 614 168"
						fill="none"
				...
				<div className={`${styles.grid_item}`}>
					<div>
						...
						<p className={styles.description}>
							We respect privacy and use state-of-the-art technology to protect
							your data.
						</p>
					</div>
				...
				<div className={`${styles.grid_item}`}>
					<div>
						...
						<p className={styles.description}>
							Navigate credit wisely with our tailored advice and financial
							foresight.
						</p>
					</div>
